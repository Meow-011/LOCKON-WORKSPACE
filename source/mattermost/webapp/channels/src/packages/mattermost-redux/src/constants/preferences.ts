...
const Preferences = {
    ...
    THEMES: {
        denim: {
            ...
            sidebarBg: '#F4EFE6',
            sidebarText: '#4A4A4A',
            sidebarUnreadText: '#1A1A1A',
            sidebarTextHoverBg: '#EAE2D3',
            sidebarTextActiveBorder: '#C1A173',
            sidebarTextActiveColor: '#1A1A1A',
            sidebarHeaderBg: '#EBE4D8',
            sidebarHeaderTextColor: '#1A1A1A',
            sidebarTeamBarBg: '#E1D8C9',
            onlineIndicator: '#5E9F6B',
            awayIndicator: '#D4A351',
            dndIndicator: '#C45B5D',
            mentionBg: '#C1A173',
            mentionBj: '#FFFFFF',
            mentionColor: '#FFFFFF',
            centerChannelBg: '#FAF7F2',
            centerChannelColor: '#333333',
            newMessageSeparator: '#C1A173',
            linkColor: '#8A6D3B',
            buttonBg: '#8A6D3B',
            buttonColor: '#FFFFFF',
            errorTextColor: '#D9534F',
            mentionHighlightBg: '#F3E9D2',
            mentionHighlightLink: '#8A6D3B',
            codeTheme: 'github',
        },
        sapphire: {
            type: 'Sapphire',
