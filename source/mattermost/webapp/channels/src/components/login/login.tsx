                                        ...
                                        >
                                            <div className='login-body-card-form'>
                                                <Input
                                                    ...
                                                    inputPrefix={<i className='icon icon-account-outline' style={{fontSize: '18px', color: 'rgba(61, 60, 64, 0.4)'}} />}
                                                    type='text'
                                                ...
                                                {(!enableGuestMagicLink || requiresPassword) && (
                                                    <>
                                                        <PasswordInput
                                                            ...
                                                            inputPrefix={<i className='icon icon-lock-outline' style={{fontSize: '18px', color: 'rgba(61, 60, 64, 0.4)'}} />}
                                                            value={password}
                                                            inputSize={SIZE.LARGE}
