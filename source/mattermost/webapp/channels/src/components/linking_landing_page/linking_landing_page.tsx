...
import MattermostLogoSvg from 'images/lockon-logo.svg';
    ...
    renderDialogHeader = () => {
        ...
        let openingLink = (
            <FormattedMessage
                ...
                defaultMessage='Opening link in LOCKON Workspace...'
            />
        );
        ...
        let viewApp = (
            <FormattedMessage
                ...
                values={{
                    siteName: this.props.enableCustomBrand ? '' : ' LOCKON Workspace',
                }}
            />
        );
        if (isMobile) {
