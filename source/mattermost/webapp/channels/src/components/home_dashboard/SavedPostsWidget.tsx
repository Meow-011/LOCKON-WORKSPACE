    ...
    return (
        <div className="widget">
            <div className="widget-header">
                <span className="widget-icon"><i className="icon icon-bookmark-outline" /></span>
                <h3>Saved Posts</h3>
                {posts.length > 0 && (
            ...
            <div className="widget-body">
                {loading ? (
                    ...
                    <div className="widget-empty">
                        <div className="widget-empty-icon"><i className="icon icon-bookmark-outline" style={{ fontSize: '48px', opacity: 0.5 }} /></div>
                        <div className="widget-empty-text">No saved posts yet</div>
                        <div className="widget-empty-hint">Click the bookmark icon on any message to save it here.</div>
