...
export default function AboutBuildModal(props: Props) {
    ...
    let title = (
        <FormattedMessage
            defaultMessage='LOCKON Workspace'
        />
    );
    ...
    let learnMore = (
        <div>
            <FormattedMessage
                ...
                defaultMessage='Join the LOCKON community at '
            />
            <ExternalLink
            ...
            learnMore = (
                <div>
                    <FormattedMessage
                        ...
                        defaultMessage='Learn more about LOCKON Workspace {planName} at {link}'
                        values={{
                            planName: skuName,
                            link: (
                                <ExternalLink
            ...
            <Modal.Body>
                ...
                <div className='about-modal__footer'>
                    ...
                    <div className='form-group'>
                        <div className='about-modal__copyright'>
                            <FormattedMessage
                                id='about.copyright'
                                defaultMessage='Copyright 2015 - {currentYear} LOCKON, Inc. All rights reserved'
                                values={{
                ...
                <div className='about-modal__notice form-group pt-3'>
                    <p>
                        <FormattedMessage
                            id='about.notice'
                            defaultMessage='LOCKON Workspace is made possible by the open source software used in our <linkServer>server</linkServer>, <linkDesktop>desktop</linkDesktop> and <linkMobile>mobile</linkMobile> apps.'
                            values={{
